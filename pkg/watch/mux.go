...
// Buffer the incoming queue a little even though it should rarely ever accumulate
...
// ActionOrDrop Action distributes the given event among all watchers, or drops it on the floor
